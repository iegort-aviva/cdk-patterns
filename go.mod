module github.com/iegort-aviva/cdk-patterns

go 1.21.6

require github.com/aws/aws-cdk-go/awscdk/v2 v2.131.0
...
require (
	...
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.131.0-alpha.0
